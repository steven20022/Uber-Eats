...
type EagerOrder = {
  ...
  readonly Restauraunt?: Restauraunt | null;
  readonly OrderDishes?: (OrderDish | null)[] | null;
  readonly createdAt?: string | null;
  readonly updatedAt?: string | null;
  readonly orderRestaurauntId?: string | null;
}
...
type LazyOrder = {
  ...
  readonly status: OrderStatus | keyof typeof OrderStatus;
  readonly userID: string;
  readonly Restauraunt: AsyncItem<Restauraunt | undefined>;
...
type EagerRestauraunt = {
  readonly [__modelMeta__]: {
    identifier: ManagedIdentifier<Restauraunt, 'id'>;
    readOnlyFields: 'createdAt' | 'updatedAt';
  };
  readonly id: string;
  readonly name: string;
...
export declare type Restauraunt = LazyLoading extends LazyLoadingDisabled ? EagerRestauraunt : LazyRestauraunt

export declare const Restauraunt: (new (init: ModelInit<Restauraunt>) => Restauraunt) & {
  copyOf(source: Restauraunt, mutator: (draft: MutableModel<Restauraunt>) => MutableModel<Restauraunt> | void): Restauraunt;
}
